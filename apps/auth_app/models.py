...
from apps.auth_app.managers import CustomUserManager
from apps.auth_app.validators import NationCodeRegexValidator
from apps.core_app.models import UpdateMixin, CreateMixin, ActiveMixin
